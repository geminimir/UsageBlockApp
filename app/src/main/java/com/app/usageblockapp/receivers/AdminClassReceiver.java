...
public class AdminClassReceiver extends DeviceAdminReceiver {
    ...
    public static boolean isDeviceAdmin(Context context) {
        try {
            return ((DevicePolicyManager) context.getSystemService(Context.DEVICE_POLICY_SERVICE)).isAdminActive(new ComponentName(context, AdminClassReceiver.class));
        } catch (Throwable t)
        {
            return false;
        }
